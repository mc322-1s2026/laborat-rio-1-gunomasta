...
* [X] calculateWorkload() deve mostrar apenas tarefas in progresse e do usuario;
* [X] Nao permitir que algum metodo/fundao modifique o id;
* [X] Nao permitir que algum metodo/funcao mude a deadline;
...
* [X] Criar uma classe Project em "com.nexus.model", que funcionara como a nova unidade de agrupamento do sistema = portifolio;
...
- [X] Para um dado projeto (parametro), calcular o percentual de conclusao dele;
- [X] Identificar qual status possui maior numero absoluto de tarefas (exceto done);
...
1. [X] **`CREATE_USER;username;email`**: Instancia um novo usuário (valide o e-mail!).
2. [X] **`CREATE_PROJECT;projectName;budgetHours`**: Instancia um novo projeto.
